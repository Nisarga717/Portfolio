        ...
        <div className="row">
            <div className="columns" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3>
                    <FormattedMessage
                        id='design'
                        defaultMessage='Web Designing UI/UX'
                    />
                </h3>
                <p>
                    <FormattedMessage
            ...
            <div className="columns" data-aos="fade-up" data-aos-delay="400">
                ...
                <p>
                    <FormattedMessage
                        id='marketing-info'
                        defaultMessage='Proficient in database management, including SQL, with a focus on designing, managing, and optimizing data systems for efficient storage, retrieval, and analysis.'
                    />
                </p>
            </div>
            ...
            <div className="columns" data-aos="fade-up" data-aos-delay="700">
                ...
                <h3>
                    <FormattedMessage
                        id='optimization'
                        defaultMessage='Blockchain/WEB3'
                    />
                </h3>
                <p>
                    <FormattedMessage
                        id='optimization-info'
                        defaultMessage='Currently exploring blockchain and Web3 technologies to deepen my understanding of decentralized systems, smart contracts, and the future of secure, transparent, and innovative applications.'
                    />
                </p>
            </div>
        </div>
